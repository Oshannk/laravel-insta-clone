...
class profilesController extends Controller
{
    public function index(User $user)
    {
        ...
        $followsCount = Cache::remember('count.follows.'.$user->id, now()->addSecond(30), function() use($user){
        ...
        return view('profiles.index', compact('user','follows','postCount','followsCount','followingCount'));
    }
